      ...
      {deleteConfirmation && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="p-6 bg-white rounded-lg shadow-xl">
            ...
            <p>Are you sure you want to delete {deleteConfirmation.basic_information.name}?</p>
            <div className="flex justify-end mt-4 space-x-2">
              ...
              <button
                ...
                onClick={() => handleDeleteCustomer(deleteConfirmation.customer_id, deleteConfirmation.basic_information.name)}
              >      Delete</button>
