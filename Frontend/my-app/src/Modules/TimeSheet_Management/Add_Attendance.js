...
//     };
//     try {
//       const response = await axios.post('https://api.sainta-erp.xyz/api/employees_timesheets', completeFormData);
...
//     try {
//       await axios.delete(`https://api.sainta-erp.xyz/api/employees_timesheets/delete-employee/${employeeToDelete.Employee_ID}`);
...
//       try {
//         const response = await axios.get('https://api.sainta-erp.xyz/api/employees_timesheets');
...
//       try {
//         const response = await axios.get('https://api.sainta-erp.xyz/api/employees');
...
//     setError(null);
//     try {
//       const response = await axios.get(`https://api.sainta-erp.xyz/api/employees_timesheets/employee/${employee.Employee_ID}`);
...
//     }
//     try {
//       await axios.put(`https://api.sainta-erp.xyz/api/employees_timesheets/${updatedData.TimeSheet_ID}`, updatedData);
...
const AddTimesheetModal = ({ isOpen, onClose, employee }) => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-auto bg-black bg-opacity-50">
        <div className="relative w-[90%] max-w-2xl p-6 mx-auto bg-white rounded-lg shadow-lg">
          ...
          <div className="flex justify-end mt-6">
            <button
              onClick={onClose}
              className="px-4 py-2 font-semibold text-white bg-[#007AAF] rounded-lg hover:bg-[#005a8c] hover:scale-110 hover:transition-all hover:duration-300 mr-4"
            >
              Close
            </button>
            <button
  ...
  return (
    <div className="container pt-4 pb-12 mx-auto">
      ...
      <Back_Btn />
      <div className="flex flex-row gap-6 pt-12">
        <div className="col-span-1 p-6 w-[36%]  rounded-lg shadow-md mb-12 ml-6 bg-yellow-400">
          <div className="flex justify-between mb-4">
            <h1 className="md:text-3xl text-2xl font-bold text-[#007AAF]">Employees</h1>
            <button
              className="px-2.5 py-2 bg-[#007AAF] text-white font-semibold rounded-lg hover:cursor-pointer hover:scale-110 hover:transition-all hover:duration-300 flex items-center"
...
export default TimeSheet_Management2;