...
const Department_Data = () => {
  ...
  useEffect(() => {
    axios.get('https://api.sainta-erp.xyz/api/departments')
      .then((response) => {
  ...
  const handleUpdate = (departmentId) => {
    axios.put(`https://api.sainta-erp.xyz/api/departments/${departmentId}`, formData)
      .then(() => {
  ...
  const handleDelete = (departmentId) => {
    axios.delete(`https://api.sainta-erp.xyz/api/departments/${departmentId}`)
      .then(() => {
