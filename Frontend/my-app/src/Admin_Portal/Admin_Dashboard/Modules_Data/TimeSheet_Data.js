...
const TimeSheet_Data = () => {
  ...
  useEffect(() => {
    axios.get('https://apisanta.devcir.co/api/employees_timesheets')
      .then((response) => {
  ...
  const handleUpdate = (timesheetId) => {
    axios.put(`https://apisanta.devcir.co/api/employees_timesheets/${timesheetId}`, formData)
      .then(() => {
  ...
  const handleDelete = () => {
    ...
    axios.delete(`https://apisanta.devcir.co/api/employees_timesheets/${timesheetToDelete.TimeSheet_ID}`)
      .then(() => {
